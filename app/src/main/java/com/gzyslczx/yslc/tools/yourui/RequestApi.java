        ...
        YRMarketConfig cc = YRMarketConfig.build()
                ...
                .setClientListener(new ClientListener() {
                    ...
                    public void onConnected() {
                        PrintTool.PrintLogD(TAG, "建立行情服务链接");
                    }

                    @Override
                    public void onDisConnected() {
                        PrintTool.PrintLogD(TAG, "断开行情服务链接");
                    }

                    @Override
                    public void onLoginServerOk() {
                        PrintTool.PrintLogD(TAG, "行情服务登录成功");
                    }

                    @Override
                    public void onSyncTemplateOk() {
                        PrintTool.PrintLogD(TAG, "行情服务模板同步成功");
                    }


                    @Override
                    public void onLoginServerError(int errorCode, String errorInfo) {
                        PrintTool.PrintLogD(TAG, String.format("行情服务登录失败，Code=%d，Info=%s", errorCode, errorInfo));
                    }
                });
